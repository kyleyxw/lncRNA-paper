...
# less stringent list
ldl_sig_genes_cond_1 <- ldl_sig_genes_cond[ldl_sig_genes_cond$P_cond < 0.05/length(unique(ldl_sig_genes_cond$gene_id)),]
write_csv(ldl_sig_genes_cond_1,file = "/rprojectnb2/pelosolab/yuxuan/lncRNA/2_results/LDL_ADJ.norm_sig_genes_cond.csv")
# more stringent list
ldl_sig_genes_cond_2 <- ldl_sig_genes_cond[ldl_sig_genes_cond$P_cond < 0.05/111550,]
write_csv(ldl_sig_genes_cond_1,file = "/rprojectnb2/pelosolab/yuxuan/lncRNA/2_results/LDL_ADJ.norm_sig_genes_cond_v2.csv")
# non significant
ldl_no_sig_genes_cond_1 <- ldl_sig_genes_cond[ldl_sig_genes_cond$P_cond >= 0.05/length(unique(ldl_sig_genes_cond$gene_id)),]
write_csv(ldl_no_sig_genes_cond_1,file = "/rprojectnb2/pelosolab/yuxuan/lncRNA/2_results/LDL_ADJ.norm_non_sig_genes_cond.csv")
# non significant
ldl_no_sig_genes_cond_2 <- ldl_sig_genes_cond[ldl_sig_genes_cond$P_cond >= 0.05/111550,]
write_csv(ldl_no_sig_genes_cond_2,file = "/rprojectnb2/pelosolab/yuxuan/lncRNA/2_results/LDL_ADJ.norm_non_sig_genes_cond_v2.csv")
...
# less stringent list
hdl_sig_genes_cond_1 <- hdl_sig_genes_cond[hdl_sig_genes_cond$P_cond < 0.05/length(unique(hdl_sig_genes_cond$gene_id)),]
write_csv(hdl_sig_genes_cond_1,file = "/rprojectnb2/pelosolab/yuxuan/lncRNA/2_results/HDL.norm_sig_genes_cond.csv")
# more stringent list
hdl_sig_genes_cond_2 <- hdl_sig_genes_cond[hdl_sig_genes_cond$P_cond < 0.05/111550,]
write_csv(hdl_sig_genes_cond_1,file = "/rprojectnb2/pelosolab/yuxuan/lncRNA/2_results/HDL.norm_sig_genes_cond_v2.csv")
# non significant
hdl_no_sig_genes_cond_1 <- hdl_sig_genes_cond[hdl_sig_genes_cond$P_cond >= 0.05/length(unique(hdl_sig_genes_cond$gene_id)),]
write_csv(hdl_no_sig_genes_cond_1,file = "/rprojectnb2/pelosolab/yuxuan/lncRNA/2_results/HDL.norm_non_sig_genes_cond.csv")
# non significant
hdl_no_sig_genes_cond_2 <- hdl_sig_genes_cond[hdl_sig_genes_cond$P_cond >= 0.05/111550,]
write_csv(hdl_no_sig_genes_cond_2,file = "/rprojectnb2/pelosolab/yuxuan/lncRNA/2_results/HDL.norm_non_sig_genes_cond_v2.csv")
...
# less stringent list
total_sig_genes_cond_1 <- total_sig_genes_cond[total_sig_genes_cond$P_cond < 0.05/length(unique(total_sig_genes_cond$gene_id)),]
write_csv(total_sig_genes_cond_1,file = "/rprojectnb2/pelosolab/yuxuan/lncRNA/2_results/TOTAL_ADJ.norm_sig_genes_cond.csv")
# more stringent list
total_sig_genes_cond_2 <- total_sig_genes_cond[total_sig_genes_cond$P_cond < 0.05/111550,]
write_csv(total_sig_genes_cond_1,file = "/rprojectnb2/pelosolab/yuxuan/lncRNA/2_results/TOTAL_ADJ.norm_sig_genes_cond_v2.csv")
# non significant
total_no_sig_genes_cond_1 <- total_sig_genes_cond[total_sig_genes_cond$P_cond >= 0.05/length(unique(total_sig_genes_cond$gene_id)),]
write_csv(total_no_sig_genes_cond_1,file = "/rprojectnb2/pelosolab/yuxuan/lncRNA/2_results/TOTAL_ADJ.norm_non_sig_genes_cond.csv")
# non significant
total_no_sig_genes_cond_2 <- total_sig_genes_cond[total_sig_genes_cond$P_cond >= 0.05/111550,]
write_csv(total_no_sig_genes_cond_2,file = "/rprojectnb2/pelosolab/yuxuan/lncRNA/2_results/TOTAL_ADJ.norm_non_sig_genes_cond_v2.csv")
...
# less stringent list
logtg_sig_genes_cond_1 <- logtg_sig_genes_cond[logtg_sig_genes_cond$P_cond < 0.05/length(unique(logtg_sig_genes_cond$gene_id)),]
write_csv(logtg_sig_genes_cond_1,file = "/rprojectnb2/pelosolab/yuxuan/lncRNA/2_results/TG_LOG.norm_sig_genes_cond.csv")
# more stringent list
logtg_sig_genes_cond_2 <- logtg_sig_genes_cond[logtg_sig_genes_cond$P_cond < 0.05/111550,]
write_csv(logtg_sig_genes_cond_1,file = "/rprojectnb2/pelosolab/yuxuan/lncRNA/2_results/TG_LOG.norm_sig_genes_cond_v2.csv")
# non significant
logtg_no_sig_genes_cond_1 <- logtg_sig_genes_cond[logtg_sig_genes_cond$P_cond >= 0.05/length(unique(logtg_sig_genes_cond$gene_id)),]
write_csv(logtg_no_sig_genes_cond_1,file = "/rprojectnb2/pelosolab/yuxuan/lncRNA/2_results/TG_LOG.norm_non_sig_genes_cond.csv")
# non significant
logtg_no_sig_genes_cond_2 <- logtg_sig_genes_cond[logtg_sig_genes_cond$P_cond >= 0.05/111550,]
write_csv(logtg_no_sig_genes_cond_2,file = "/rprojectnb2/pelosolab/yuxuan/lncRNA/2_results/TG_LOG.norm_non_sig_genes_cond_v2.csv")
