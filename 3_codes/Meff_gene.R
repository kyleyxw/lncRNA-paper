...
path <- "/rprojectnb2/pelosolab/yuxuan/lncRNA/3_results/"
...
for (chr in 22:1){
  ...
  for (i in annot){
    ...
    tmp <- read.csv(paste0("/rprojectnb2/pelosolab/yuxuan/lncRNA/1_results/LDL_ADJ.norm_",i,".csv"))
  ...
  fwrite(corscore,
         file = paste0("/rprojectnb2/pelosolab/yuxuan/lncRNA/3_results/topmed_lncRNA_",chr, "_gene_cor.csv"),
